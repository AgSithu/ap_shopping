            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    if (empty($_POST['search'])) {
                        ...
                        $stmt = $pdo->prepare("SELECT * FROM posts WHERE title LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numberOfrecs");
                        $stmt->execute();
                        $result = $stmt->fetchAll();
                    }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="container">
                                                        <a href="delete.php?id=<?php echo $value['id'] ?>" onclick="return confirm('Are you sure want to delete this item')" type="button" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
