            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    if (empty($_POST['search']) && empty($_COOKIE['search'])) {
                        ...
                        $stmt = $pdo->prepare("SELECT * FROM users WHERE name LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset,$numberOfrecs");
                        $stmt->execute();
                        $result = $stmt->fetchAll();
                    }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="container">
                                                        <a href="user_delete.php?id=<?php echo $value['id'] ?>" onclick="return confirm('Are you sure want to delete this item')" type="button" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
